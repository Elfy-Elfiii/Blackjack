...
def résultat(somme_carte_croupier, somme_carte_joueur, nb_carte_croupier,
             nb_carte_joueur, joueur):
    resultat = ""
    if somme_carte_croupier > somme_carte_joueur and somme_carte_croupier <= 21 or somme_carte_joueur > 21:
        if est_blackjack(somme_carte_croupier,
                         nb_carte_croupier) and assurances[joueur]:
        ...
        if not est_blackjack(somme_carte_croupier,
                             nb_carte_croupier) and est_blackjack(
                                 somme_carte_joueur, nb_carte_joueur):
            porte_monaie[joueur] += 2 * mise[joueur] + mise[joueur] // 2
        else:
